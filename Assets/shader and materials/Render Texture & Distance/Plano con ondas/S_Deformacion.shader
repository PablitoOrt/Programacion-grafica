...
Shader "S_Deformacion"
{
	...
	SubShader
	{
		...
		void vertexDataFunc( inout appdata_full v )
		{
			...
			float3 temp_output_10_0 = ( temp_output_9_0 * float3(0,4,0) * 0.14 );
		...
		{
			float4 color15 = IsGammaSpace() ? float4(0.3378222,0.2042542,0.8490566,0) : float4(0.0933823,0.03444577,0.6903409,0);
			float4 color14 = IsGammaSpace() ? float4(0.04672481,0.6603774,0.379054,0) : float4(0.003647695,0.3936214,0.1186586,0);
...
/*ASEBEGIN
Version=18900
172;73;1369;608;1306.267;424.0034;1.9;False;False
Node;AmplifyShaderEditor.Vector3Node;2;-805.2225,367.1877;Inherit;False;Property;_Epicenter;Epicenter;5;0;Create;True;0;0;0;False;0;False;0,0,0;0,0,0;0;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
...
Node;AmplifyShaderEditor.RangedFloatNode;7;-373.1227,389.588;Inherit;False;Property;_Frecuency;Frecuency;6;0;Create;True;0;0;0;False;0;False;2;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;12;-24.82328,515.2877;Inherit;False;Constant;_Height;Height;2;0;Create;True;0;0;0;False;0;False;0.14;0;0;0;0;1;FLOAT;0
...
ASEEND*/
//CHKSM=C0EE08AFE20A36F92A0291CBE508C404C2E7B1A5