...
Shader "S_WavingWater"
{
	...
	SubShader
	{
		...
		void vertexDataFunc( inout appdata_full v )
		{
			...
			float temp_output_34_0 = ( sin( ( ( temp_output_23_0 * _Frecuency ) - mulTime24 ) ) * ( 1.0 - smoothstepResult32 ) );
			v.vertex.xyz += ( temp_output_34_0 * float3(0,1,0) * 0.1 );
			v.vertex.w = 1;
		}
		...
		void surf( Input i , inout SurfaceOutputStandard o )
		{
			...
			float time4 = _Time.y;
			float2 coords4 = i.uv_texcoord * 10.0;
			float2 id4 = 0;
			float2 uv4 = 0;
...
/*ASEBEGIN
Version=18900
723;73;936;618;1132.194;-155.8837;1.325053;False;False
Node;AmplifyShaderEditor.CommentaryNode;35;-2138.434,417.9045;Inherit;False;1283.841;514.2847;Comment;12;22;21;23;27;25;24;30;33;32;31;28;34;;1,1,1,1;0;0
Node;AmplifyShaderEditor.Vector3Node;21;-2075.434,683.7053;Inherit;False;Property;_Epicenter;Epicenter;6;0;Create;True;0;0;0;False;0;False;0,0,0;0,0,-50;0;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
Node;AmplifyShaderEditor.WorldPosInputsNode;22;-2088.434,467.9045;Inherit;False;0;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
Node;AmplifyShaderEditor.RangedFloatNode;30;-1598.462,687.1086;Inherit;False;Property;_speed;speed;5;0;Create;True;0;0;0;False;0;False;2;2;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.DistanceOpNode;23;-1869.539,585.9757;Inherit;False;2;0;FLOAT3;0,0,0;False;1;FLOAT3;0,0,0;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;25;-1727.327,539.1058;Inherit;False;Property;_Frecuency;Frecuency;7;0;Create;True;0;0;0;False;0;False;2;8;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;2;-1708.403,287.0643;Inherit;False;Constant;_voronoiScale;voronoiScale;0;0;Create;True;0;0;0;False;0;False;10;10;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SimpleTimeNode;24;-1469.942,693.7929;Inherit;False;1;0;FLOAT;1;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.SmoothstepOpNode;32;-1682.148,773.1893;Inherit;False;3;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;5;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;16;-649.0981,900.7847;Inherit;False;Constant;_height;height;2;0;Create;True;0;0;0;False;0;False;0.1;0;0;0;0;1;FLOAT;0
...
ASEEND*/
//CHKSM=629CE8A3023CCCFB7A08E16CB093196AE16A0247